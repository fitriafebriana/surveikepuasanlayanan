@extends('layouts.dashboard', [
    'breadcrumbs' => [
        'Kuesioner' => route('tambahlayanan.index'),
        'Tambah Kuesioner' => '#',
    ],
])
...
@section('content')
	<x-card>
		<div class="relative overflow-x-auto p-5 sm:rounded-lg">
			<form action="{{ route('tambahlayanan.store') }}" method="POST">
				@csrf
				{{-- <div class="mb-3">
				...
				<div class="mb-4 w-full rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
					...
					<div class="rounded-b-lg bg-white px-4 py-2 dark:bg-gray-800">
						...
						<textarea id="editor" rows="8" name="question" class="block w-full border-0 bg-white px-0 text-sm text-gray-800 focus:ring-0 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400" placeholder="Tulis pertanyaan tambahlayanan..."></textarea>
					</div>
				</div>
